...
void Header::print() {
    ...
    printf("difficulty: %d \n",  static_cast<int>(getDifficulty()));
    printf("number: %d \n",  static_cast<int>(getNumber()));
    printf("gasLimit: %d \n",  static_cast<int>(getGasLimit()));
    printf("gasUsed: %d \n",  static_cast<int>(getGasUsed()));
    printf("timestamp: %lu \n",  getTimestamp());
...
void TransactionReceipt::print() {
    printf("blockNumber: %d \n", static_cast<int>(getBlockNumber()));
    printf("blockHash: %s \n",  getBlockHash().c_str());
    printf("transactionIndex: %d \n", static_cast<int>(getTransactionIndex()));
    printf("status: %s \n",  getStatus().c_str());
    printf("cumulativeGasUsed: %d \n",  static_cast<int>(getCumulativeGasUsed()));
    printf("logsBloom: %s \n",  getLogsBloom().c_str());
...
int Transaction::getNonce() {return static_cast<int>(bytesVectorToInt(nonce_bytes));}
double Transaction::getGasPrice() {return hexastr2double("0x"+bytesVectorToHexString(gasPrice_bytes)); }
int Transaction::getGasLimit() {return static_cast<int>(bytesVectorToInt(gasLimit_bytes));}
