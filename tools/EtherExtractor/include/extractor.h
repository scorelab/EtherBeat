...
*/
#ifndef TOOLS_ETHEREXTRACTOR_INCLUDE_EXTRACTOR_H_
#define TOOLS_ETHEREXTRACTOR_INCLUDE_EXTRACTOR_H_
...
class EtherExtractor {
 ...
 private:
    ...
    void
    updateTxReceipts(std::vector<TransactionReceipt> *receipts, uint64_t blockNumber, std::vector<uint8_t> blockHash,
                     std::vector<uint8_t> contents, RLP &rlp);
...
#endif  // TOOLS_ETHEREXTRACTOR_INCLUDE_EXTRACTOR_H_
